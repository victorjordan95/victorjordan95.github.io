...
},success:function(){$contactForm.find(".loading").hide(),$contactForm.append('<div class="alert success">Message sent!</div>'),$(".alert .alert-success").delay(4e3).hide()},error:function(){$contactForm.find(".loading").hide(),$contactForm.append('<div class="alert error">Ops, there was an error.</div>')}})});
